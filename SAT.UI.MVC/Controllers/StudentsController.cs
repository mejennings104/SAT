...
namespace SAT.UI.MVC.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FirstName,LastName,Major,Adress,City,State,ZipCode,Phone,Email,PhotoUrl,Ssid")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstName,LastName,Major,Adress,City,State,ZipCode,Phone,Email,PhotoUrl,Ssid")] Student student)
        {
